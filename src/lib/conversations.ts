...
export type ConversationVisibility = "public" | "private" | "group";
...
export type ConversationMessage = {
  ...
  created_at: string;
  profiles?: { name: string | null; avatar_url: string | null } | null;
  reply_to_data?: { content: string | null; profiles: { name: string | null } | null } | null;
};
...
export async function archiveConversation(id: string): Promise<void> {
  ...
  if (error) console.error("[conversations] archiveConversation error:", error);
}
