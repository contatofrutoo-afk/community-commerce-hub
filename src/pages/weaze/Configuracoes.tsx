...
export default function WeazeConfiguracoes() {
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) => setForm((prev) => ({ ...prev, defaultPlanValue: Number(e.target.value) }))}
            />
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Textarea
              ...
              onChange={(e) => setForm((prev) => ({ ...prev, blockedMessage: e.target.value }))}
              rows={3}
            />
          </div>
        </CardContent>
